...
export class PatientLgpd1677479804571 implements MigrationInterface {
  name = "PatientLgpd1677479804571";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "patients" ADD "lgpdKey" text NULL`);
