...
export class MedicalAppointments1676727981517 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "medical_appointments" ADD CONSTRAINT "FK_fe453fa8ff1f01f2628fe291b4d" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
