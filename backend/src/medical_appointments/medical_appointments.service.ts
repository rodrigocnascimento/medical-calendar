...
export class MedicalAppointmentsService {
  ...
  async create(createMedicalAppointmentDto: CreateMedicalAppointmentDto) {
    try {
      await this.medicalAppointmentRepo.alreadyHasAppointment(createMedicalAppointmentDto.date);
  ...
  update(id: UUIDVersion, updateMedicalAppointmentDto: UpdateMedicalAppointmentDto) {
